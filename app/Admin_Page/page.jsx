                ...
                <div className={`w-full pt-5 px-4 md:px-7 bg-gray-50 dark:bg-gray-950 ${isSidebarOpen ? 'h-screen overflow-hidden' : ''}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10 ">
                        <section className="flex flex-col justify-center h-[25vh] xl:h-[195px] w-full rounded-xl shadow-xl bg-white border border-gray-300 px-3 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <p className="mt-3 flex items-center">Your total revenue this month.<span className="ml-3 flex bg-orange-200 text-orange-500 rounded-sm"><TrendingUp/>+20%</span></p>
                        </section>
                        <section className="flex flex-col justify-center h-[25vh] xl:h-[195px] w-full rounded-xl shadow-xl bg-white border border-gray-300 px-3 dark:bg-gray-900 dark:border-gray-900">
