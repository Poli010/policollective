                            ...
                            <div className="w-86 md:w-60 bg-white dark:bg-gray-900 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
                                ...
                                <div className="px-10 md:px-4 py-3">
                                    ...
                                    <div className='flex flex-row just items-center'>
                                        {product.stock_quantity > 0 ? (<p className="text-gray-600 dark:text-gray-300 text-sm">Status: Active </p>) :  (<p className="text-gray-600 dark:text-gray-300 text-sm">Status: Out of Stock </p>)}
                                        {product.stock_quantity > 0 ? (<p className='bg-yellow-500 rounded-full w-3 h-3 ml-1'></p>) :  (<p className='bg-red-500 rounded-full w-3 h-3 ml-1'></p>)}
                                    </div>
                                    ...
                                    <div className="flex justify-between mt-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-semibold text-center">{product.stock_quantity}</p>
                                        </div>
                                    </div>
                                </div>
                                {/* ACTION BUTTONS */}
