                            ...
                            <section className="pt-5">
                                <div className="hidden items-center justify-center h-[250px] p-10 lg:p-14 md:block">
                                    <Carousel className="w-full max-w-full">
                                        <CarouselContent >
                                            {multipleImage.map((image, index) => ( 
                                                <CarouselItem className={`basis-1/1 md:basis-1/2 lg:basis-1/3 h-[230px]`} key={index}><img src={`/uploads/${encodeURIComponent(image)}`} loading="lazy" alt="multiple image" className="w-full h-full object-contain rounded-md"/></CarouselItem>
                                            ))}
                                        </CarouselContent>
